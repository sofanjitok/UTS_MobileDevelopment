package id.rdev.sofanji180900986a.network

import id.rdev.sofanji180900986a.activity.data_barang.data.ResultDataBarang
import id.rdev.sofanji180900986a.activity.login.data.ResultLogin
import id.rdev.sofanji180900986a.activity.penjualan.data.ResultKeranjang
import id.rdev.sofanji180900986a.activity.penjualan.data.ResultSearchBarang
import id.rdev.sofanji180900986a.activity.report.detail.data.ResultItemKeranjang
import id.rdev.sofanji180900986a.response.ResultSimple
